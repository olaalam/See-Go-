...
const CoverPage = () => {
  ...
  const fetchImages = async () => {
    ...
    try {
      const coverRes = await fetch(
        `https://bcknd.sea-go.org/admin/village_cover/${id}`,
        {
          headers: {
      ...
      setCoverImage(coverData.village.cover_image_link);

      const profileRes = await fetch(
        `https://bcknd.sea-go.org/admin/village/item/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
      ...
      setProfileImage(profileData.village.image_link);
    } catch (error) {
  ...
  const handleImageUpload = async () => {
    ...
    try {
      const response = await fetch(
        `https://bcknd.sea-go.org/admin/village_cover/add/${id}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDeleteImage = async () => {
    ...
    try {
      const response = await fetch(
        `https://bcknd.sea-go.org/admin/village_cover/delete/${id}`,
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleUpdateProfileImage = async () => {
    ...
    try {
      const response = await fetch(
        `https://bcknd.sea-go.org/admin/village/update_profile_image/${id}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
